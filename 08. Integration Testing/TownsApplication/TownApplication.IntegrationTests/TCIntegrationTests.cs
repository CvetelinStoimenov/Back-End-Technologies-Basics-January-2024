...
{
    public class TCIntegrationTests
    {
        private readonly TownController _controller;

        public TCIntegrationTests()
        {
        ...
        public void UpdateTown_ShouldUpdatePopulation()
        {
            ...
            _controller.UpdateTown(townId.Id, updatedPopulation);
        ...
        public void ListTowns_ShouldReturnTowns()
        {
            ...
            var townsToAdd = new List<string> { "Sofia", "Plovdiv", "Varna", "Stara Zagora" };
